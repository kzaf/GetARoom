...
public class Fragment_Search extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        adapter = new SimpleAdapter(getActivity(), records, R.layout.traveler_hotel_search_list, new String[] {"name","city"}, new int[] {R.id.tv,R.id.sub});
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                Toast.makeText(getActivity(), "Select option for hotel " + hashMap.get("name"), Toast.LENGTH_SHORT).show();
                ((MainActivity) getActivity()).hotelBooking(hashMap.get("name"), hashMap.get("city"), checkin, checkout);
            }
        });
        return rootView;
    }
